...
public class EmployeeTest {
	...
	public void compensationOfJuniorAssociate() {
		...
		Employee juniorAssociate = new Employee(121, new JuniorAssociate(), SALARY);
	...
	public void parkingSpaceOfJuniorAssociate() {
		Employee juniorAssociate = new Employee(121, new JuniorAssociate(), new BigDecimal("20000.00"));
	...
	public void promoteJuniorAssociate() {
		...
		assertEquals(new SeniorAssociate(), juniorAssociate.getLevel());
	}
	
	@Test
	public void compensationOfSeniorAssociate() {
		BigDecimal SALARY = new BigDecimal("50000.00");
		Employee seniorAssociate = new Employee(99, new SeniorAssociate(), SALARY);
	...
	public void parkingSpaceOfSeniorAssociate() {
		Employee seniorAssociate = new Employee(99, new SeniorAssociate(), new BigDecimal("50000.00"));
	...
	public void promoteSeniorAssociate() {
		...
		assertEquals(new JuniorPartner(), seniorAssociate.getLevel());
	}
	
	@Test
	public void compensationOfJuniorPartner() {
		BigDecimal SALARY = new BigDecimal("100000.00");
		Employee seniorAssociate = new Employee(29, new JuniorPartner(), SALARY);
	...
	public void parkingSpaceOfJuniorPartner() {
		Employee seniorAssociate = new Employee(29, new JuniorPartner(), new BigDecimal("100000.00"));
	...
	public void promoteJuniorPartner() {
		Employee seniorAssociate = new Employee(29, new JuniorPartner(), new BigDecimal("100000.00"));
		seniorAssociate.promote();
		assertEquals(new SeniorPartner(), seniorAssociate.getLevel());
	}
	
	@Test
	public void compensationOfSeniorPartner() {
		BigDecimal SALARY = new BigDecimal("200000.00");
		Employee seniorAssociate = new Employee(4, new SeniorPartner(), SALARY);
	...
	public void parkingSpaceOfSeniorPartner() {
		Employee seniorAssociate = new Employee(4, new SeniorPartner(), new BigDecimal("200000.00"));
		assertTrue(seniorAssociate.hasParkingSpace());		
	}
